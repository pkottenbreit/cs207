...
The wire used was all old 22-4 telephone wire (see Appendix 2). We prefer to work with solid wires over braided.
...
You can also label these wires when using DCS-BIOS, to make it easier to know which pins you are using for what specific control.  See Appendix 4 & 5 for example.
...
See Appendix 6 for the code that we wrote to Map DCS_BIOS to our specific button box and run on an Arduino Mega.
...
![](https://github.com/pkottenbreit/cs207/blob/main/telephone%20wire.jpg)
...
## Appendix 5: Unlabelled mess
![](https://github.com/pkottenbreit/cs207/blob/main/PXL_20201125_211719478.jpg)

## Appendix 6: code we used to enable DCS_BIOS using the Arduino Mega
``` cpp
